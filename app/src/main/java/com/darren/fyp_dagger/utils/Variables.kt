...
val faceDetected: MutableState<Boolean> = mutableStateOf(false)
...
val smiling: MutableState<Boolean> = mutableStateOf(false)
...
val leftYDeltaList: MutableList<Float> = mutableListOf()
val rightYDeltaList: MutableList<Float> = mutableListOf()
val noseXDeltaList: MutableList<Float> = mutableListOf()
val noseYDeltaList: MutableList<Float> = mutableListOf()
...
val textHelperOption: MutableState<Boolean> = mutableStateOf(true)
val mlModeOption: MutableState<Boolean> = mutableStateOf(true)
